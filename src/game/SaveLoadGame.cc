...
static void SaveGeneralInfo(HWFILE const f)
{
	...
	INJ_U8(   d, static_cast<UINT8>(preBattleSector.x))
	INJ_U8(   d, static_cast<UINT8>(preBattleSector.y))
	INJ_U8(   d, static_cast<UINT8>(preBattleSector.z))
...
static void LoadGeneralInfo(HWFILE const f, UINT32 const savegame_version)
{
	...
	UINT8 temp;
	EXTR_U8(   d, temp);	preBattleSector.x = temp;
	EXTR_U8(   d, temp);	preBattleSector.y = temp;
	EXTR_U8(   d, temp);	preBattleSector.z = temp;
